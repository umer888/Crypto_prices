...
var generate_graph = function(till, from, year=false) {
    ...
    var res = get_api_records(coin,active_currency,start_date,end_date,year);
    var chart = new CanvasJS.Chart("chartContainer", {

        
	axisY: {
        yValueFormatString: "#,##0.0"+active_currency
	},
        data: [{ 
            type: "area", 
            color: "#cce6ff",
            toolTipContent: "{label}: {y} "+active_currency, 
...
var get_epoch_with_difference = function(date, duration) {
 ...
 var get_api_records = function(coin,market,start,end,year=false) {
